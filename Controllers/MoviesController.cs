...
namespace MvcMovie.Controllers
{
    public class MoviesController : Controller
    {
        ...
        // GET: Movies
        // GET: Movies
        public async Task<IActionResult> Index(int MovieGenre, string searchString, string OrderBy)
        {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,GenreId,Price,Rating,ImageUrl")] Movie movie, Genre genre)
        {
